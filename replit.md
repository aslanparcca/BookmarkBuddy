...
- June 14, 2025. Added debug logging to Excel processing: investigating why subheadings from Excel are not being detected and used in article generation, examining column names and data structure
```
